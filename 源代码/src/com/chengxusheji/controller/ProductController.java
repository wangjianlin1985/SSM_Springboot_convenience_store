...
public class ProductController extends BaseController {
	...
	public void add(@Validated Product product, BindingResult br,
		...
		try {
			product.setMainImage(this.handlePhotoUpload(request, "mainImageFile"));
	...
	public void update(@Validated Product product, BindingResult br,
		...
		String mainImageFileName = this.handlePhotoUpload(request, "mainImageFile");
		if(!mainImageFileName.equals("upload/NoImage.jpg"))product.setMainImage(mainImageFileName); 
	...
	public void OutToExcel(@ModelAttribute("productClassObj") ProductClass productClassObj,String productName,String addTime, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "商品id","商品类别","商品名称","商品主图","商品价格","发布时间"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<productList.size();i++) {
        	Product product = productList.get(i); 
        	dataset.add(new String[]{product.getProductId() + "",product.getProductClassObj().getProdcutClassName(),product.getProductName(),product.getMainImage(),product.getPrice() + "",product.getAddTime()});
        }
        /*
