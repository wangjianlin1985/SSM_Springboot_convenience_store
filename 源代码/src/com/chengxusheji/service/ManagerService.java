...
public class ManagerService {
    ...
    /*按照查询条件分页查询店铺管理员记录*/
    public ArrayList<Manager> queryManager(String managerUserName,Shop shopObj,String name,String birthday,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!managerUserName.equals("")) where = where + " and t_manager.managerUserName like '%" + managerUserName + "%'";
    	if(null != shopObj && shopObj.getShopId()!= null && shopObj.getShopId()!= 0)  where += " and t_manager.shopObj=" + shopObj.getShopId();
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Manager> queryManager(String managerUserName,Shop shopObj,String name,String birthday,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!managerUserName.equals("")) where = where + " and t_manager.managerUserName like '%" + managerUserName + "%'";
    	if(null != shopObj && shopObj.getShopId()!= null && shopObj.getShopId()!= 0)  where += " and t_manager.shopObj=" + shopObj.getShopId();
    	if(!name.equals("")) where = where + " and t_manager.name like '%" + name + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String managerUserName,Shop shopObj,String name,String birthday,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!managerUserName.equals("")) where = where + " and t_manager.managerUserName like '%" + managerUserName + "%'";
    	if(null != shopObj && shopObj.getShopId()!= null && shopObj.getShopId()!= 0)  where += " and t_manager.shopObj=" + shopObj.getShopId();
    	if(!name.equals("")) where = where + " and t_manager.name like '%" + name + "%'";
