...
public class SupplierService {
    ...
    /*按照查询条件分页查询供应商记录*/
    public ArrayList<Supplier> querySupplier(String supplierName,String farendaibiao,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!supplierName.equals("")) where = where + " and t_supplier.supplierName like '%" + supplierName + "%'";
    	if(!farendaibiao.equals("")) where = where + " and t_supplier.farendaibiao like '%" + farendaibiao + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Supplier> querySupplier(String supplierName,String farendaibiao,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!supplierName.equals("")) where = where + " and t_supplier.supplierName like '%" + supplierName + "%'";
    	if(!farendaibiao.equals("")) where = where + " and t_supplier.farendaibiao like '%" + farendaibiao + "%'";
    	if(!telephone.equals("")) where = where + " and t_supplier.telephone like '%" + telephone + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String supplierName,String farendaibiao,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!supplierName.equals("")) where = where + " and t_supplier.supplierName like '%" + supplierName + "%'";
    	if(!farendaibiao.equals("")) where = where + " and t_supplier.farendaibiao like '%" + farendaibiao + "%'";
    	if(!telephone.equals("")) where = where + " and t_supplier.telephone like '%" + telephone + "%'";
