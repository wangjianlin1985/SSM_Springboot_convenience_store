				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
 										...
 										<tr>
 											...
 											<td><%=productClass.getProdcutClassName() %></td>
 											<td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="productClass_prodcutClassName_edit" class="col-md-3 text-right">商品类别名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productClass_prodcutClassName_edit" name="productClass.prodcutClassName" class="form-control" placeholder="请输入商品类别名称">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (productClass, response, status) {
			if (productClass) {
				...
				$("#productClass_prodcutClassName_edit").val(productClass.prodcutClassName);
