		       ...
		       text: "门店管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Shop/shop_add.jsp"
			    	   	},
			    		{
			    	   		text: "门店管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Shop/shop_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "供应商管理",
		       ...
		       text: "商品库存管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Stock/stock_add.jsp"
			    	   	},
			    		{
			    	   		text: "商品库存管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Stock/stock_query_result.jsp"
			    	    }
			    	   ]
			},/*{
		       text: "商品进货管理",
		       ...
		       text: "商品调拨管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Transfer/transfer_add.jsp"
			    	   	},
			    		{
			    	   		text: "商品调拨管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Transfer/transfer_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
