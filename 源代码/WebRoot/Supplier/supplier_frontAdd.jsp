			...
			<div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="supplierAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="supplier_farendaibiao" class="col-md-2 text-right">法人代表:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="supplier_farendaibiao" name="supplier.farendaibiao" class="form-control" placeholder="请输入法人代表">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="supplier_telephone" class="col-md-2 text-right">供应商电话:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="supplier_telephone" name="supplier.telephone" class="form-control" placeholder="请输入供应商电话">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="supplier_address" class="col-md-2 text-right">供应商地址:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="supplier_address" name="supplier.address" class="form-control" placeholder="请输入供应商地址">
							 </div>
						  </div>
				          <div class="form-group">
