...
<div id="supplier_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="supplierQueryForm" method="post">
			...
			法人代表：<input type="text" class="textbox" id="farendaibiao" name="farendaibiao" style="width:110px" />
			供应商电话：<input type="text" class="textbox" id="telephone" name="telephone" style="width:110px" />
