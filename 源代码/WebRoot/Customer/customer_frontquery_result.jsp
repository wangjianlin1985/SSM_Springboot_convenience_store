...
<%
    ...
    String regTime = (String)request.getAttribute("regTime"); //加入时间查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#customerListPanel" aria-controls="customerListPanel" role="tab" data-toggle="tab">客户列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Customer/customer_frontAdd.jsp" style="display:none;">添加客户</a></li>
				</ul>
			  	<!-- Tab panes -->
			  	<div class="tab-content">
				    <div role="tabpanel" class="tab-pane active" id="customerListPanel">
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				<div class="table-responsive">
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>客户id</td><td>姓名</td><td>性别</td><td>出生日期</td><td>联系电话</td><td>加入时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<customerList.size();i++) {
					    	            		...
					    	            		Customer customer = customerList.get(i); //获取到客户对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											...
 											<td><%=customer.getRegTime() %></td>
 											<td>
 												<a href="<%=basePath  %>Customer/<%=customer.getCustomerId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="customerEdit('<%=customer.getCustomerId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="customerDelete('<%=customer.getCustomerId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="customerQueryForm" id="customerQueryForm" action="<%=basePath %>Customer/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="regTime">加入时间:</label>
				<input type="text" id="regTime" name="regTime" class="form-control"  placeholder="请选择加入时间" value="<%=regTime %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
...
<div id="customerEditDialog" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer"> 
      	...
      	<button type="button" class="btn btn-primary" onclick="ajaxCustomerModify();">提交</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
function GoToPage(currentPage,totalPage) {
    ...
    document.customerQueryForm.currentPage.value = currentPage;
...
function changepage(totalPage)
{
    ...
    document.customerQueryForm.currentPage.value = pageValue;
    documentcustomerQueryForm.submit();
}
		...
		$.ajax({
			...
			success : function (obj) {
				if (obj.success) {
					...
					//location.href= basePath + "Customer/frontlist";
				}
				else 
					alert(obj.message);
			},
