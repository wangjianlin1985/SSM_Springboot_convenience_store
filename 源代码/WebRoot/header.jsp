...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">连锁店管理</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Shop/frontlist">门店</a></li>
                <li><a href="<%=basePath %>Supplier/frontlist">供应商</a></li>
                <li><a href="<%=basePath %>Customer/frontlist">客户</a></li>
                <!-- 
                <li><a href="<%=basePath %>Manager/frontlist">店铺管理员</a></li> -->
                <li><a href="<%=basePath %>Stock/frontlist">商品库存</a></li>
                <li><a href="<%=basePath %>BuyInfo/frontlist">商品进货</a></li>
                <li><a href="<%=basePath %>Sell/frontlist">商品销售</a></li>
                <li><a href="<%=basePath %>Transfer/frontlist">商品调拨</a></li>
